...
})({"80Y9b":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "506cc5ec92237f05";
"use strict";
...
},{}],"gBuA8":[function(require,module,exports) {
...
const firebaseApp = (0, _app.initializeApp)({
    ...
    databaseURL: "https://percussioninstruments-f921d.firebaseio.com",
...
const messaging = (0, _sw.getMessaging)(firebaseApp); /*
...
},{"firebase/app":"ecYT9","firebase/messaging/sw":"l1Wpv"}],"ecYT9":[function(require,module,exports) {
...
},{"@firebase/app":"1S7U5","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"1S7U5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/component":"6t3wR","@firebase/logger":"9OAoM","@firebase/util":"1iJon","idb":"lmbmI","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"6t3wR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/util":"1iJon","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"1iJon":[function(require,module,exports) {
/**
 * @license
...
},{"d07263985281b344":"1aR2K","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"1aR2K":[function(require,module,exports) {
...
},{}],"9OAoM":[function(require,module,exports) {
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"lmbmI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"l1Wpv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _sw = require("@firebase/messaging/sw");
parcelHelpers.exportAll(_sw, exports);

},{"@firebase/messaging/sw":"9TYy6","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"9TYy6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "experimentalSetDeliveryMetricsExportedToBigQueryEnabled", ()=>experimentalSetDeliveryMetricsExportedToBigQueryEnabled);
parcelHelpers.export(exports, "getMessaging", ()=>getMessagingInSw);
parcelHelpers.export(exports, "isSupported", ()=>isSwSupported);
parcelHelpers.export(exports, "onBackgroundMessage", ()=>onBackgroundMessage);
...
/** Key of FCM Payload in Notification's data field. */ const FCM_MSG = "FCM_MSG";
...
function createFcmEvent(internalPayload, fid) {
    var _a, _b;
    const fcmEvent = {};
    /* eslint-disable camelcase */ // some fields should always be non-null. Still check to ensure.
    if (!!internalPayload.from) fcmEvent.project_number = internalPayload.from;
    if (!!internalPayload.fcmMessageId) fcmEvent.message_id = internalPayload.fcmMessageId;
    fcmEvent.instance_id = fid;
    if (!!internalPayload.notification) fcmEvent.message_type = MessageType$1.DISPLAY_NOTIFICATION.toString();
    else fcmEvent.message_type = MessageType$1.DATA_MESSAGE.toString();
    fcmEvent.sdk_platform = SDK_PLATFORM_WEB.toString();
    fcmEvent.package_name = self.origin.replace(/(^\w+:|^)\/\//, "");
    if (!!internalPayload.collapse_key) fcmEvent.collapse_key = internalPayload.collapse_key;
    fcmEvent.event = EVENT_MESSAGE_DELIVERED.toString();
    if (!!((_a = internalPayload.fcmOptions) === null || _a === void 0 ? void 0 : _a.analytics_label)) fcmEvent.analytics_label = (_b = internalPayload.fcmOptions) === null || _b === void 0 ? void 0 : _b.analytics_label;
    /* eslint-enable camelcase */ return fcmEvent;
}
function createAndEnqueueLogEvent(messaging, fcmEvent, productId) {
    const logEvent = {};
    /* eslint-disable camelcase */ logEvent.event_time_ms = Math.floor(Date.now()).toString();
    logEvent.source_extension_json_proto3 = JSON.stringify(fcmEvent);
    if (!!productId) logEvent.compliance_data = buildComplianceData(productId);
    // eslint-disable-next-line camelcase
...
async function onPush(event, messaging) {
    ...
    if (!internalPayload) // Failed to get parsed MessagePayload from the PushEvent. Skip handling the push.
    return;
    // log to Firelog with user consent
    if (messaging.deliveryMetricsExportedToBigQueryEnabled) await stageLog(messaging, internalPayload);
    // foreground handling: eventually passed to onMessage hook
    const clientList = await getClientList();
    if (hasVisibleClients(clientList)) return sendMessagePayloadInternalToWindows(clientList, internalPayload);
    // background handling: display if possible and pass to onBackgroundMessage hook
    if (!!internalPayload.notification) await showNotification(wrapInternalPayload(internalPayload));
    if (!messaging) return;
    if (!!messaging.onBackgroundMessageHandler) {
        const payload = externalizePayload(internalPayload);
        if (typeof messaging.onBackgroundMessageHandler === "function") await messaging.onBackgroundMessageHandler(payload);
        else messaging.onBackgroundMessageHandler.next(payload);
    }
}
 ...
 */ async function getWindowClient(url) {
    ...
    for (const client of clientList){
        ...
        if (url.host === clientUrl.host) return client;
    }
    return null;
}
/**
...
function sendMessagePayloadInternalToWindows(clientList, internalPayload) {
    ...
    for (const client of clientList)client.postMessage(internalPayload);
}
 ...
 */ function registerMessagingInSw() {
    (0, _app._registerComponent)(new (0, _component.Component)("messaging-sw", SwMessagingFactory, "PUBLIC" /* ComponentType.PUBLIC */ ));
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ async function isSwSupported() {
    ...
    return (0, _util.isIndexedDBAvailable)() && await (0, _util.validateIndexedDBOpenable)() && "PushManager" in self && "Notification" in self && ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification") && PushSubscription.prototype.hasOwnProperty("getKey");
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ function onBackgroundMessage$1(messaging, nextOrObserver) {
    if (self.document !== undefined) throw ERROR_FACTORY.create("only-available-in-sw" /* ErrorCode.AVAILABLE_IN_SW */ );
...
},{"@firebase/installations":"hCOP6","@firebase/component":"6t3wR","idb":"lmbmI","@firebase/util":"1iJon","@firebase/app":"1S7U5","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}],"hCOP6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"1S7U5","@firebase/component":"6t3wR","@firebase/util":"1iJon","idb":"lmbmI","@parcel/transformer-js/src/esmodule-helpers.js":"jRKQF"}]},["80Y9b","gBuA8"], "gBuA8", "parcelRequirea6aa")
