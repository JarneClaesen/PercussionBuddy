 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e=(0,m.getApp)()){return l9().then(e=>{if(!e)throw lR.create("unsupported-browser")},e=>{throw lR.create("indexed-db-unsupported")}),(0,m._getProvider)((0,w.getModularInstance)(e),"messaging").getImmediate()}(l6);let l3=[];var l8={};l8=new URL("firebase-messaging-sw.js",import.meta.url).toString(),"serviceWorker"in navigator&&navigator.serviceWorker.register(l8).then(function(e){console.log("Service Worker Registered",e)}).catch(function(e){console.log("Service Worker registration failed: ",e)}),document.addEventListener("DOMContentLoaded",async()=>{let e=document.getElementById("search-input"),t=document.getElementById("search-results"),n=document.getElementById("instrument-details");async function i(){let e=localStorage.getItem("instrumentsList");if(e)l3=JSON.parse(e),console.log("Instruments list retrieved from Local Storage");else{let e=function(e,t,...n){if(e=(0,w.getModularInstance)(e),/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index.5498d358.js.map
