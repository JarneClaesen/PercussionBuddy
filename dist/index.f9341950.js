 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iC{constructor(e){this.path=e}static fromPath(e){return new iC(iT.fromString(e))}static fromName(e){return new iC(iT.fromString(e).popFirst(5))}static empty(){return new iC(iT.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===iT.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return iT.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new iC(new iT(e.slice()))}}class iI{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new iI(iE.min(),iC.empty(),-1)}static max(){return new iI(iE.max(),iC.empty(),-1)}}class ik{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(e=>e())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function iA(e){if(e.code!==ir.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==e.message)throw e;n3("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s0{constructor(){this.Pr=new iG(s1.Ir),this.Tr=new iG(s1.Er)}isEmpty(){return this.Pr.isEmpty()}addReference(e,t){let n=new s1(e,t);this.Pr=this.Pr.add(n),this.Tr=this.Tr.add(n)}dr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Ar(new s1(e,t))}Rr(e,t){e.forEach(e=>this.removeReference(e,t))}Vr(e){let t=new iC(new iT([])),n=new s1(t,e),i=new s1(t,e+1),r=[];return this.Tr.forEachInRange([n,i],e=>{this.Ar(e),r.push(e.key)}),r}mr(){this.Pr.forEach(e=>this.Ar(e))}Ar(e){this.Pr=this.Pr.delete(e),this.Tr=this.Tr.delete(e)}gr(e){let t=new iC(new iT([])),n=new s1(t,e),i=new s1(t,e+1),r=rX();return this.Tr.forEachInRange([n,i],e=>{r=r.add(e.key)}),r}containsKey(e){let t=new s1(e,0),n=this.Pr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class s1{constructor(e,t){this.key=e,this.pr=t}static Ir(e,t){return iC.comparator(e.key,t.key)||iy(e.pr,t.pr)}static Er(e,t){return iy(e.pr,t.pr)||iC.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lY(e,t){t?e.vapidKey=t:e.vapidKey||(e.vapidKey=lb)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t,n){if(!n)throw new is(ir.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}("collection","path",t),e instanceof oT){let i=iT.fromString(t,...n);return ow(i),new oC(e,null,i)}{if(!(e instanceof o_||e instanceof oC))throw new is(ir.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let i=e._path.child(iT.fromString(t,...n));return ow(i),new oC(e.firestore,null,i)}}(l5,"Instruments");l3=(await function(e){e=oE(e,oS);let t=oE(e.firestore,ok),n=(t._firestoreClient||oA(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient),i=new oB(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index.f9341950.js.map
